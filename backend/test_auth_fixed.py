print("=== Виправлений тест авторизації ===")
...
try:
    ...
    test_password = "test123"  # Коротший пароль
    hashed_password = get_password_hash(test_password)
    print(f"   ✅ Пароль успішно захешовано: {hashed_password[:30]}...")
    ...
    if found_user:
        ...
        # Перевіряємо пароль
        if verify_password("test123", found_user.hashed_password):
